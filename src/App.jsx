  ...
  return (
    <div className="min-h-screen selection:bg-[var(--charcoal)] selection:text-[var(--sand)]">
      ...
      <section className="relative w-full h-[100svh] flex flex-col md:flex-row border-b-2 border-structural overflow-hidden bg-[var(--olive)] md:bg-transparent">
        ...
        <div className="relative w-full md:w-1/2 h-full bg-transparent md:bg-[var(--sand)] flex flex-col justify-start md:justify-center pt-[15vh] md:pt-0 px-6 pl-8 md:pl-1000 lg:px-16 z-20 md:z-auto pointer-events-none md:pointer-events-auto">
